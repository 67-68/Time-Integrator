...
def action_type_is(intended_at):
    def matcher(au):
        at = au["action_type"]
        if intended_at == at:
            return True
...
def duration_is_greater_than(duration):
    def matcher(au):
