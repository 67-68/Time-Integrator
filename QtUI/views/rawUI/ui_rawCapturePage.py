...
class Ui_CapturePage(object):
    def setupUi(self, CapturePage):
        ...
        self.singleEnterButton = QtWidgets.QRadioButton(parent=self.leftToolFrame)
        self.singleEnterButton.setObjectName("singleEnterButton")
        self.enterModeGroup = QtWidgets.QButtonGroup(CapturePage)
        self.enterModeGroup.setObjectName("enterModeGroup")
        self.enterModeGroup.addButton(self.singleEnterButton)
        self.verticalLayout_2.addWidget(self.singleEnterButton)
        self.multipleEnterButton = QtWidgets.QRadioButton(parent=self.leftToolFrame)
        self.multipleEnterButton.setObjectName("multipleEnterButton")
        self.enterModeGroup.addButton(self.multipleEnterButton)
        self.verticalLayout_2.addWidget(self.multipleEnterButton)
    ...
    def retranslateUi(self, CapturePage):
        ...
        self.singleEnterButton.setText(_translate("CapturePage", "Single Enter"))
        self.multipleEnterButton.setText(_translate("CapturePage", "Multiple Enter"))
