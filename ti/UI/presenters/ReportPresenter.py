...
class ReportPresenter():
    def __init__(self,data,service: dict):
        ...
        # self.IE: InsightEngine = service["IE"]
        # self.IE.inillialize(self.card_recipe.get_conditional_card())
        
        # self.IM: InsightManager = service["IM"]
